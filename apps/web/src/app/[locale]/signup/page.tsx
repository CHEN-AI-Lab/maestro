        ...
        <div className="max-w-sm w-full mx-auto px-4">
          <div className="bg-white rounded-xl border p-8 shadow-sm">
            ...
            <p className="text-sm text-gray-500 text-center mb-6">
              {locale === 'zh' ? '创建账号，开始使用' : 'Create your account and get started'}
            </p>
              ...
              <form onSubmit={handleMagicLink} className="space-y-3">
                ...
                >
                  {loading === 'resend'
                    ...
                    : (locale === 'zh' ? '发送验证链接' : 'Send Verification Link')}
                </button>
              </form>
            )}
            ...
            <div className="mt-4 text-center">
              ...
              <Link href="/signin" className="text-sm text-indigo-600 hover:underline ml-1">
